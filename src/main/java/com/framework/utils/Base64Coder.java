...
public class Base64Coder {
	...
	public static void main(String[] args) {
		byte[] toEncode = "P@ssw0rd10!".getBytes();
		
		logger.info(encode(toEncode)); 
	}
	...
	public static byte[] decode(char[] in, int iOff, int iLen) {
		...
		while (ip < iEnd) {
			...
			checkIfAllParameterAreGreaterThan127(i0, i1, i2, i3);
			...
			checkIfAllParametersAreNegative(b0, b1, b2, b3);
	...
	private static void checkIfLengthIsValid(int iLen) {
		if (iLen % 4 != 0) {
			throw new IllegalArgumentException("Length of Base64 encoded input string is not a multiple of 4.");
		}
	}
	
	private static void checkIfAllParameterAreGreaterThan127(int i0, int i1, int i2, int i3) {
		if (i0 > 127 || i1 > 127 || i2 > 127 || i3 > 127) {
			throw new IllegalArgumentException("Illegal character in Base64 encoded data.");
		}
	}
	
	private static void checkIfAllParametersAreNegative(int b0, int b1, int b2, int b3) {
