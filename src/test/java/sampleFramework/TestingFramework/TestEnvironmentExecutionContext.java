...
public class TestEnvironmentExecutionContext {
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(allowImplicitWait, other.allowImplicitWait)
				...
				&& Objects.equals(runLocation, other.runLocation) && Objects.equals(testName, other.testName)
	...
	public String toString() {
		...
		for (Map.Entry<String, String> entry : sortedMap.entrySet()) {
			...
			if (Boolean.FALSE.equals(value.isEmpty()))
				...
				stringBuilder.append(String.format("%n  - %s = %s", entry.getKey(), entry.getValue()));
